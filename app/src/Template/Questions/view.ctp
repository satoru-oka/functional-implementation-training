...
<section class="question">
    <div class="card mb-3">
        <div class="card-body">
            <h5 class="card-title">
                <!-- TODO:ユーザー管理機能時実装 -->
                <i class="fas fa-user-circle"></i> <?= 'tarou' ?>
            </h5>
...
<section class="answer mb-4">
    <?php if ($answers->isEmpty()): ?>
        <div class="card w-75 mb-2 ml-auto">
            <div class="card-body">
                <h5 class="card-title text-center">No response yet.</h5>
            </div>
        </div>
    <?php else: ?>
        <div class="w-75 ml-auto">
            <h5><i class="fas fa-reply"></i> Answer</h5>
        </div>
            ...
            <div class="card w-75 mb-2 ml-auto">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        <i class="fas fa-user-circle"></i> <?= 'Jiro' ?>
                    </h5>
...
<section class="answer-post mb-5">
    ...
    <?php if ($answer->count() >= 100): ?>
        <p class="text-center">回答数が上限に達している為これ以上回答することはできません</p>
    <?php else: ?>
        <?= $this->Form->create($newAnswer, ['urll' => '/answers/add']) ?>
        <?php
